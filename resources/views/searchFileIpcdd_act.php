            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <h1 class="h5 mb-3">Search / IPCDD DROM</h1>
                            <form method="post" id="submitSearch">
                                <label class="form-label">CADT</label>
                                <select class="form-control choices-multiple-area mb-0" name="area_id[]" multiple>
                        ...
                        <div class="col-sm-9">
                            <div class="table-responsive">
                                <table id="tbl_searchFileResult" class="table table-hover" style="width:100%">
                                    <thead>
