<div class="col-md-3 col-xl-2">
    <div class="card">
        <div class="list-group list-group-flush" role="tablist">
            ...
            <a class="list-group-item list-group-item-action <?php echo $app->sidebar_active('findings', $_GET['m']); echo $app->sidebar_active('view_dqa', $_GET['m']);  ?>" href="home.php?p=act&m=view_dqa" role="tab">
                Findings
