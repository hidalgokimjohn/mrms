        ...
        <div class="col-12 col-md-6 col-lg-8">
            <div class="card">
                ...
                <div class="m-3 mt-1">
                    ...
                    <a href="home.php?p=act&m=generate_findings&cycle=<?php echo $_GET['cycle'] ?>&area=<?php echo $_GET['area'] ?>" class="p-1"><span class="fa fa-print"></span> Generate Findings <span class="badge bg-success">New</span></a>
                </div>
            </div>
            <div class="row">
                <style type="text/css">
