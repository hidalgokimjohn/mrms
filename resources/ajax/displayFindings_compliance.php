...
$app = new \app\App();
    ...
    if (!empty($displayFindings)) {
        echo '<h5 class="mb-3">1st level DQA Findings:<br><small>Tick the box if it is complied.</small></h5>';
        foreach ($displayFindings as $displayFinding) {
            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div class="float-end me-n2">
													<label class="form-check">
														<input type="checkbox" name="complied_findings[]" value="'.$displayFinding['findings_guid'].'" class="form-check-input" checked="">
														<span class="form-check-label d-none">Checkbox</span>
													</label>
												</div>
